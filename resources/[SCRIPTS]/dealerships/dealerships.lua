local vehicleLocations = {
    {
        ...
        vehicles = {
            ...
            {model = "deity", price = 200000, spawnCoords = vector4(-37.4381, -1093.3636, 26.6837, 24.3173)},
            {model = "turismo2", price = 300000, spawnCoords = vector4(-42.3216, -1101.3484, 26.5996, 202.7966)},
            {model = "torero2", price = 850000, spawnCoords = vector4(-54.5700, -1097.1466, 26.6648, 36.5422)},
            {model = "cypher", price = 110000, spawnCoords = vector4(-50.0374, -1083.8835, 26.7209, 248.1748)}
        }
    },
    {
        ...
        vehicles = {
            ...
            {model = "schlagen", price = 130000, spawnCoords = vector4(-1269.5414, -364.3029, 36.4759, 348.1712)},
            {model = "sm722", price = 530000, spawnCoords = vector4(-1270.8866, -358.6362, 36.5220, 252.5311)},
            {model = "jugular", price = 80000, spawnCoords = vector4(-1266.7131, -355.1023, 36.6212, 156.8050)},
            {model = "italirsx", price = 800000, spawnCoords = vector4(-1256.2686, -366.7053, 36.5240, 119.0064)},
            {model = "vstr", price = 120000, spawnCoords = vector4(-1231.6013, -347.1530, 36.7516, 84.8176)},
            {model = "mamba", price = 250000, spawnCoords = vector4(-1232.5981, -344.3934, 36.6237, 84.5981)},
            {model = "jester4", price = 90000, spawnCoords = vector4(-1262.9005, -353.0871, 36.5500, 159.8858)}
        }
    },
    {
        ...
        vehicles = {
            {model = "bobcatxl", price = 50000, spawnCoords = vector4(-183.8735, -1174.4535, 22.8161, 200.2589)},
            {model = "caracara2", price = 65000, spawnCoords = vector4(-187.4485, -1174.4419, 22.7557, 201.1267)},
            {model = "chino", price = 25000, spawnCoords = vector4(-191.2062, -1173.9224, 22.5504, 198.6254)},
            {model = "dominator", price = 70000, spawnCoords = vector4(-194.5041, -1174.2670, 22.3339, 201.3005)},
            {model = "dominator8", price = 130000, spawnCoords = vector4(-198.1103, -1174.0259, 22.5818, 201.1661)},
            {model = "dominator3", price = 140000, spawnCoords = vector4(-132.7579, -1182.2493, 23.1985, 89.2911)},
            {model = "fmj", price = 500000, spawnCoords = vector4(-132.7255, -1178.5524, 23.1522, 89.9427)},
            {model = "retinue2", price = 35000, spawnCoords = vector4(-132.8439, -1175.0988, 23.1611, 90.4346)},
            {model = "hustler", price = 95000, spawnCoords = vector4(-132.8413, -1170.0684, 23.1250, 90.2164)},
            {model = "huntley", price = 60000, spawnCoords = vector4(-132.5133, -1166.6763, 23.1110, 91.1502)},
            {model = "hotknife", price = 105000, spawnCoords = vector4(-139.0159, -1162.4037, 23.0873, 180.8218)},
            {model = "gb200", price = 130000, spawnCoords = vector4(-144.1555, -1162.3588, 23.0167, 180.6370)},
            {model = "emerus", price = 220000, spawnCoords = vector4(-151.7991, -1166.4474, 23.0631, 270.5679)},
            {model = "t20", price = 120000, spawnCoords = vector4(-152.1866, -1170.0413, 23.3449, 269.4490)},
            {model = "flashgt", price = 90000, spawnCoords = vector4(-147.6172, -1162.4351, 23.5649, 181.0142)}
        }
    },
    {
        ...
        vehicles = {
            {model = "gp1", price = 1200000, spawnCoords = vector4(1238.3577, 2698.5774, 37.3880, 32.7099)},
            {model = "locust", price = 160000, spawnCoords = vector4(1232.9938, 2698.4314, 37.4296, 33.1491)},
            {model = "penetrator", price = 940000, spawnCoords = vector4(1226.3961, 2697.7588, 37.2928, 34.9226)},
            {model = "rhinehart", price = 120000, spawnCoords = vector4(1219.3116, 2697.5757, 37.7466, 33.2378)},
            {model = "revolter", price = 190000, spawnCoords = vector4(1220.4451, 2708.1797, 37.5136, 272.8931)},
            {model = "entityxf", price = 750000, spawnCoords = vector4(1228.6248, 2708.5330, 37.4072, 182.3869)},
            {model = "infernus2", price = 1300000, spawnCoords = vector4(1234.7684, 2708.6638, 37.5308, 91.0315)},
            {model = "sultan", price = 85000, spawnCoords = vector4(1227.8799, 2718.9260, 37.3985, 180.2785)},
            {model = "elegy", price = 160000, spawnCoords = vector4(1221.9530, 2719.4041, 37.3304, 178.5236)},
